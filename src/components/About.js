        ...
        <article className='media'>
          ...
          <div className='media-content'>
            <div className='content has-text-grey-light'>
              ...
              <p className='mb-1'>
                I'm naturally curious, excited for challenges, with a good eye
                for details, and always working on improving my skills and
              ...
              <p>
                In the beginning of my professional journey back in 2014 and
                until 2018, I've played different roles from QA automation
                developer to support and business analyst which I consider that
                gave me another point of view and helps me to be successful as a
                software developer.
              </p>
