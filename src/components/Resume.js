        ...
        <div className="columns mb-6">
          ...
          <div className="column is-two-third">
            ...
            <div class="block">
              ...
              <progress class="progress" value="80" max="100">
                80%
              </progress>
            </div>
          </div>
          ...
          <div className="column is-two-third">
            <div class="block">
              ...
              <ul>
                ...
                <li>
                  Implemented best practices cross-teams to get the codebase
                  more maintainable.
                </li>
                <li>
                  Contributed with the application architecture planning for the
                  client.
                </li>
                <li>Contributed on the UX design of several projects.</li>
                <li>
                  Councelled junior teammates on the next steps on their
                  careers, giving continous feedback on them.
                </li>
              </ul>
            </div>
            <div class="block">
            ...
            <div class="block">
              <h4>Fullstack Developer @ Accenture</h4>
              <h6>2018 - 2020</h6>
              <ul>
                <li>
